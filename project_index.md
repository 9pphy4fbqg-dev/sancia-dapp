...
# 主网合约地址
REACT_APP_PRIVATE_SALE_CONTRACT_ADDRESS=0xDA069b1f78de236BAa3be3CFB828Ea4933C82dC9
REACT_APP_USDT_ADDRESS=0x55d398326f99059fF775485246999027B3197955
REACT_APP_REFERRAL_CENTER_ADDRESS=0xEf201c7Bf54Bf4de038E68Aa6A479c15470c845A
REACT_APP_SANCIA_TOKEN_ADDRESS=0xc872e7C4d7C878dAB143f4482fBd4Fe7C464E11C
...
**修改内容**：
- GIT平台不支持动态导航，修改部署平台为Vercel
- 优化部署配置，修复Vercel部署白屏问题
- 增加钱包拓展，支持币安钱包、TP钱包、SafePal钱包、OKX钱包、imToken钱包
- 保留WalletConnect功能，支持AVE钱包等其他钱包
- 更新了钱包连接界面的分组和显示
- 修复交易成功后黑色模态框遮挡问题
- 优化模态框样式，确保遮罩层正确显示和隐藏
- 修复移动端模态框大小和刷新延迟问题
- 优化模态框背景残留问题
- 修复LOGO在手机端钱包浏览器不显示问题
- 优化移动端私募页面USDT授权状态框排版
- 修复推荐树模态框顶部白色横块问题
- 修复页面刷新后出现全黑遮罩问题